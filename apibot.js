...
var bot_token = '2126134306:AAEtbMeseSPs9CfZ__epJ5aW1tunE0Gf5rk'; //YOUR BOT TOKEN HERE
var bot_name = 'GoogleMoney_TBot';
...
const admin_id = 1135301576;
var mongo_url = 'mongodb+srv://DATA1:bQRFmueJrQg5qtiK@cluster0.fm84z.mongodb.net/myFirstDatabase?retryWrites=true&w=majority'; // Your Mongo URL Here
const buttonsLimit = {
    window: 1000,
    limit: 1,
        ...
        if (bots == 'Active') {
            ...
            if (flag == channel.length) {
                ...
                if (statdata.length == 0) {
                    ...
                    ctx.reply(
                        '<b>📊 Bot Live Stats 📊\n\n📤 Total Payouts : 0 ' + currency + '\n\n💡 Total Users: ' + members.length + ' Users\n\n✅ Created By : <a href="https://lootteam.xyz">Loot-Team</a></b>' , { parse_mode: 'html', reply_markup: { keyboard: [['💰 Balance'], ['👫 Invite', '🎁 Bonus', '🗂 Wallet'], ['💵 Withdraw', '📊 Statistics']], resize_keyboard: true } }
                    )
                } else {
      ...
      return 0;
        ...
        ctx.replyWithMarkdown( 
            ...
            bot.telegram.sendMessage(pay, "<b>✅ New Withdrawal Requested ✅\n\n🟢 User : <a href='tg://user?id=" + ctx.from.id + "'>" + ctx.from.id + "</a>\n\n🚀Amount : " + toWith + " " + currency + "\n⛔ Address :</b> <code>" + wallet + "</code>\n\n<b>💡 Bot: @" + ctx.botInfo.username + "</b>", { parse_mode: 'html' })
             ...
             let amount = toWith
             let url = 'https://api.earningarea.in/?key=ahwkkkdwchyprsdggqdf&token=c7ae85c27bb07439050fe3ed627db8ea&mid=3732&amo='+amount+'&com='+comment+'&num='+wallet;
             axios.post(url);
    }
    await ctx.scene.leave('onWithdraw')
  } catch(err) {
